...
namespace Vueling.XXX.DB.Infrastructure.MapFactories.MapDomainToConceptualModel.FleetRepository
{
    class AircraftEntityToAircraftDbObjectFactory : MapDomainToConceptualModelFactoryBase
    {
        ...
        internal override TOutput GetDbObjectFromEntity<TInput, TOutput>(TInput entity)
        {
            ...
            Vueling.XXX.DB.Infrastructure.Repositories.FleetRepository.Aircraft dbAircraftObject = new Vueling.XXX.DB.Infrastructure.Repositories.FleetRepository.Aircraft();
