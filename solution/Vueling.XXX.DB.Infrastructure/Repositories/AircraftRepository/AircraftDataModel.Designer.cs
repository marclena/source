...
namespace Vueling.XXX.DB.Infrastructure.Repositories.AircraftRepository
{
    ...
    /// </summary>
    public partial class AircraftDbEntities : ObjectContext
    {
        #region Constructores
    
        /// <summary>
        /// Inicializa un nuevo objeto AircraftDbEntities usando la cadena de conexión encontrada en la sección 'AircraftDbEntities' del archivo de configuración de la aplicación.
        /// </summary>
        public AircraftDbEntities() : base("name=AircraftDbEntities", "AircraftDbEntities")
        {
            OnContextCreated();
        }
    
        /// <summary>
        /// Inicializar un nuevo objeto AircraftDbEntities.
        /// </summary>
        public AircraftDbEntities(string connectionString) : base(connectionString, "AircraftDbEntities")
        {
            OnContextCreated();
        }
        ...
        /// Inicializar un nuevo objeto AircraftDbEntities.
        /// </summary>
        public AircraftDbEntities(EntityConnection connection) : base(connection, "AircraftDbEntities")
        {
            OnContextCreated();
        }
    ...
    /// No hay documentación de metadatos disponible.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="AircraftDataModel", Name="Aircraft")]
    [Serializable()]
