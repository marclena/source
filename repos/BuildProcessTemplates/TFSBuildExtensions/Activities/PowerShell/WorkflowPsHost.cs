namespace TFSBuildExtensions.PowerShell
{
    ...
    internal class WorkflowPsHost : PSHost
    {
        ...
        {
            this.activityContext.TrackBuildMessage(string.Format(this.CurrentCulture, "{0} has started", "PSHost"), BuildMessageImportance.Low);
        }

        public override void NotifyEndApplication()
        {
            this.activityContext.TrackBuildMessage(string.Format(this.CurrentCulture, "{0} has completed", "PSHost"), BuildMessageImportance.Low);
        }
